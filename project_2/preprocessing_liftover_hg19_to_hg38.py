...
# Run with: python /tscc/nfs/home/jiweng/code/vcfAnnotation/helper/liftover_maf_hg19_to_hg38.py -i /tscc/projects/ps-gleesonlab9/user/jiweng/courses/TCGA.LUAD.mutations.txt -c /tscc/nfs/home/jiweng/ps-gleesonlab7/gleeson3/resources/hg38/hg19ToHg38.over.chain.gz -r /tscc/nfs/home/jiweng/ps-gleesonlab7/gleeson3/reference_fasta/GRCh38_full_analysis_set_plus_decoy_hla.fa -o /tscc/projects/ps-gleesonlab9/user/jiweng/courses/TCGA.LUAD.mutations.hg38.txt
import argparse
import pandas as pd
